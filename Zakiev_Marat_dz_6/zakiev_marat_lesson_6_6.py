...
# # python zakiev_marat_lesson_6_6.py 5978,5
# # python zakiev_marat_lesson_6_6.py 8914,3
# ########################################
# python zakiev_marat_lesson_6_6.py 5978,5 8914,3 7879,1 1573,7 5978,5 1573,7 25,65 358,5 792,3
...
def main():
    ...
    param = sys.argv[1:]
    for arg in param:
        with open('bakery.csv', 'a', encoding='utf-8') as out_f:
            text = f'{arg}\n'
            out_f.write(text)
