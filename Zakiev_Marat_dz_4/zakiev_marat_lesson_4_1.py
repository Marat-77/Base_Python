...
# (или другой, отличной от самой свежей). Сделать подтверждающий скриншот. Деактивировать виртуальное окружение.
...
# Задание сохранил в zakiev_marat_lesson_4_1.html
# файлы скриншотов в папке images
# так же файлы скриншотов в zakiev_marat_lesson_4_1.zip
